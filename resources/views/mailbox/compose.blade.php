...
<script>
  $(function () {
    $("li.nav-item.sb-mailbox").eq(0).addClass("menu-is-opening menu-open");
    $("li.nav-item.sb-mailbox a.nav-link").eq(0).addClass("active");
    $("a.nav-link.sb-mailbox-compose").eq(0).addClass("active");
    //Add text editor
