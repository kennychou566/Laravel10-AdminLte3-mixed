...
<head>
  ...
  <title>Fixed Sidebar custom</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
             <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Fixed SideBar<small> Custom</small></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<script>
    $(document).ready(function () {
        ...
        $("a.nav-link.sb-layout-fixed-sidebar-custom").eq(0).addClass("active");
    });
