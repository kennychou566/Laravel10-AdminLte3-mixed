  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          You can Change Pace Styles, Checkout the <a href="#" target="_blank" rel="noopener noreferrer">Laravel10 + AdminLTE package </a> in Online.
          <br>
...
<script>
    $(document).ready(function () {
        ...
        $("a.nav-link.sb-extras-pace").eq(0).addClass("active");
    });
